 ...
 * @param a0
 * @param l
 * @returns Radial threshold distance for early exit optimization
 */
 ...
 * @param r
 * @param a0
 * @returns Absolute magnitude of the radial wavefunction at distance r
 */
 ...
 * @param l
 * @param dimension
 * @returns Density boost factor for the given quantum numbers
 */
