/**
 * TSL 10D Mandelbulb SDF
 *
 * 10D Hyperbulb signed distance function with orbit traps.
 * Uses 9 hyperspherical angles.
 *
 * @module rendering/tsl/raymarching/mandelbulb/sdf10d
 */
...
export const createMandelbulb10DSDF = (uniforms: Mandelbulb9D11DUniforms) => {
  return Fn(([pos]: [Vec3Node]) => {
    ...
    const z6 = float(c6).toVar(), z7 = float(c7).toVar(), z8 = float(c8).toVar(), z9 = float(c9).toVar()
    ...
    Loop(MAX_ITER_HQ, ({ i }) => {
      ...
      r.assign(sqrt(zxzy_sq.add(zz.mul(zz)).add(z3.mul(z3)).add(z4.mul(z4)).add(z5.mul(z5)).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9))))
      ...
      const r1 = sqrt(zxzy_sq.add(z3.mul(z3)).add(z4.mul(z4)).add(z5.mul(z5)).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9))).toVar()
      const t1 = r1.greaterThan(EPS).select(acos(clamp(zx.div(max(r1, float(EPS))), float(-1), float(1))), float(0)).toVar()
      const r2 = sqrt(zy.mul(zy).add(z3.mul(z3)).add(z4.mul(z4)).add(z5.mul(z5)).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9))).toVar()
      const t2 = r2.greaterThan(EPS).select(acos(clamp(zy.div(max(r2, float(EPS))), float(-1), float(1))), float(0)).toVar()
      const r3 = sqrt(z3.mul(z3).add(z4.mul(z4)).add(z5.mul(z5)).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9))).toVar()
      const t3 = r3.greaterThan(EPS).select(acos(clamp(z3.div(max(r3, float(EPS))), float(-1), float(1))), float(0)).toVar()
      const r4 = sqrt(z4.mul(z4).add(z5.mul(z5)).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9))).toVar()
      const t4 = r4.greaterThan(EPS).select(acos(clamp(z4.div(max(r4, float(EPS))), float(-1), float(1))), float(0)).toVar()
      const r5 = sqrt(z5.mul(z5).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9))).toVar()
      const t5 = r5.greaterThan(EPS).select(acos(clamp(z5.div(max(r5, float(EPS))), float(-1), float(1))), float(0)).toVar()
      const r6 = sqrt(z6.mul(z6).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9))).toVar()
      const t6 = r6.greaterThan(EPS).select(acos(clamp(z6.div(max(r6, float(EPS))), float(-1), float(1))), float(0)).toVar()
      const r7 = sqrt(z7.mul(z7).add(z8.mul(z8)).add(z9.mul(z9))).toVar()
      const t7 = r7.greaterThan(EPS).select(acos(clamp(z7.div(max(r7, float(EPS))), float(-1), float(1))), float(0)).toVar()
      const t8 = atan(z9, z8).toVar()
      ...
      const p5 = p4.mul(s4), p6 = p5.mul(s5), p7 = p6.mul(s6), p8 = p7.mul(s7)
      ...
      z6.assign(p6.mul(c6_).add(c6)); z7.assign(p7.mul(c7_).add(c7)); z8.assign(p8.mul(c8_).add(c8)); z9.assign(p8.mul(s8).add(c9))
      escIt.assign(i)
    })
...
export const createMandelbulb10DSDFSimple = (uniforms: Mandelbulb9D11DUniforms) => {
  return Fn(([pos]: [Vec3Node]) => {
    const bx0 = uniforms.uBasisX0, by0 = uniforms.uBasisY0, bz0 = uniforms.uBasisZ0, o0 = uniforms.uOrigin0
    const bx1 = uniforms.uBasisX1, by1 = uniforms.uBasisY1, bz1 = uniforms.uBasisZ1, o1 = uniforms.uOrigin1
    const bx2 = uniforms.uBasisX2, by2 = uniforms.uBasisY2, bz2 = uniforms.uBasisZ2, o2 = uniforms.uOrigin2
    ...
    Loop(MAX_ITER_HQ, ({ i }) => {
      If(i.greaterThanEqual(maxIt), () => Break())
      r.assign(sqrt(zx.mul(zx).add(zy.mul(zy)).add(zz.mul(zz)).add(z3.mul(z3)).add(z4.mul(z4)).add(z5.mul(z5)).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9))))
      ...
      const r1 = sqrt(zxzy_sq.add(z3.mul(z3)).add(z4.mul(z4)).add(z5.mul(z5)).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9)))
      const t1 = r1.greaterThan(EPS).select(acos(clamp(zx.div(max(r1, float(EPS))), float(-1), float(1))), float(0))
      const r2 = sqrt(zy.mul(zy).add(z3.mul(z3)).add(z4.mul(z4)).add(z5.mul(z5)).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9)))
      const t2 = r2.greaterThan(EPS).select(acos(clamp(zy.div(max(r2, float(EPS))), float(-1), float(1))), float(0))
      const r3 = sqrt(z3.mul(z3).add(z4.mul(z4)).add(z5.mul(z5)).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9)))
      const t3 = r3.greaterThan(EPS).select(acos(clamp(z3.div(max(r3, float(EPS))), float(-1), float(1))), float(0))
      const r4 = sqrt(z4.mul(z4).add(z5.mul(z5)).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9)))
      const t4 = r4.greaterThan(EPS).select(acos(clamp(z4.div(max(r4, float(EPS))), float(-1), float(1))), float(0))
      const r5 = sqrt(z5.mul(z5).add(z6.mul(z6)).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9)))
      const t5 = r5.greaterThan(EPS).select(acos(clamp(z5.div(max(r5, float(EPS))), float(-1), float(1))), float(0))
      const r6 = sqrt(z6.mul(z6).add(z7.mul(z7)).add(z8.mul(z8)).add(z9.mul(z9)))
      const t6 = r6.greaterThan(EPS).select(acos(clamp(z6.div(max(r6, float(EPS))), float(-1), float(1))), float(0))
      const r7 = sqrt(z7.mul(z7).add(z8.mul(z8)).add(z9.mul(z9)))
      ...
      const p0 = rp, p1 = p0.mul(s0), p2 = p1.mul(s1), p3 = p2.mul(s2), p4 = p3.mul(s3), p5 = p4.mul(s4), p6 = p5.mul(s5), p7 = p6.mul(s6), p8 = p7.mul(s7)
      zz.assign(p0.mul(c0).add(cz)); zx.assign(p1.mul(c1).add(cx)); zy.assign(p2.mul(c2).add(cy))
      z3.assign(p3.mul(c3_).add(c3)); z4.assign(p4.mul(c4_).add(c4)); z5.assign(p5.mul(c5_).add(c5))
      z6.assign(p6.mul(c6_).add(c6)); z7.assign(p7.mul(c7_).add(c7)); z8.assign(p8.mul(c8_).add(c8)); z9.assign(p8.mul(s8).add(c9))
    })
