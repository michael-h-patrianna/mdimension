/**
 * Hydrogen ND for 9D - Hydrogen orbital + 6 HO dimensions
 *
 * Fully unrolled for performance.
 */
export const hydrogenND9dBlock = `
// ============================================
// Hydrogen ND - 9D (6 Extra Dimensions)
// ============================================

vec2 evalHydrogenNDPsi9D(float xND[MAX_DIM], float t) {
    ...
    float R = hydrogenRadial(uPrincipalN, uAzimuthalL, r9D, uBohrRadius);
    ...
    float extraProduct = ef0 * ef1 * ef2 * ef3 * ef4 * ef5;
