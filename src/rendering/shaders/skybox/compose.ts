...
export function composeSkyboxFragmentShader(config: SkyboxShaderConfig) {
  ...
  switch (mode) {
    case 'aurora': modeBlock = auroraBlock; break;
    case 'nebula': modeBlock = nebulaBlock; break;
    case 'void': modeBlock = voidBlock; break;
    case 'crystalline': modeBlock = crystallineBlock; break;
    case 'horizon': modeBlock = horizonBlock; break;
    case 'ocean': modeBlock = oceanBlock; break;
    case 'twilight': modeBlock = twilightBlock; break;
    case 'starfield': modeBlock = starfieldBlock; break;
  }
  ...
  const blocks = [
    ...
    { name: 'Main', content: generateMain(mode, {
