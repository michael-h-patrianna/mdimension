...
import { createShadowMapUniforms, updateShadowMapUniforms, collectShadowDataCached } from '../shadows/uniforms';
...
export class VolumetricFogPass extends Pass {
    ...
    public update(scene: THREE.Scene, camera: THREE.Camera, deltaTime: number) {
        ...
        // Update Fog Uniforms
        if (this.material.uniforms.uFogHeight) this.material.uniforms.uFogHeight.value = fogState.fogHeight;
        if (this.material.uniforms.uFogFalloff) this.material.uniforms.uFogFalloff.value = fogState.fogFalloff;
        if (this.material.uniforms.uFogDensity) this.material.uniforms.uFogDensity.value = fogState.fogDensity;
        if (this.material.uniforms.uFogColor) this.material.uniforms.uFogColor.value.set(fogState.fogColor);
        if (this.material.uniforms.uFogNoiseScale) this.material.uniforms.uFogNoiseScale.value = fogState.fogNoiseScale;
        if (this.material.uniforms.uFogNoiseSpeed) this.material.uniforms.uFogNoiseSpeed.value.fromArray(fogState.fogNoiseSpeed);
        if (this.material.uniforms.uFogScattering) this.material.uniforms.uFogScattering.value = fogState.fogScattering;
        if (this.material.uniforms.uVolumetricShadows) this.material.uniforms.uVolumetricShadows.value = fogState.volumetricShadows;
        if (this.material.uniforms.uTime) this.material.uniforms.uTime.value += deltaTime;

        // Camera Uniforms
        if (this.material.uniforms.uCameraPosition) this.material.uniforms.uCameraPosition.value.copy(camera.position);
        ...
        if (this.material.uniforms.uInverseViewProj) this.material.uniforms.uInverseViewProj.value.copy(this.viewProjMatrix.invert());
        ...
        if (this.compositeMaterial.uniforms.uCameraNear) this.compositeMaterial.uniforms.uCameraNear.value = cameraNear;
        if (this.compositeMaterial.uniforms.uCameraFar) this.compositeMaterial.uniforms.uCameraFar.value = cameraFar;
        ...
        if (sun) {
            ...
            if (this.material.uniforms.uLightColor) this.material.uniforms.uLightColor.value.set(sun.color);
            if (this.material.uniforms.uLightIntensity) this.material.uniforms.uLightIntensity.value = sun.intensity;
        }
        ...
        const lightPositions = this.material.uniforms.uLightPositions?.value as THREE.Vector3[] | undefined;
    ...
    public render(renderer: THREE.WebGLRenderer, writeBuffer: THREE.WebGLRenderTarget, readBuffer: THREE.WebGLRenderTarget, _deltaTime?: number, _stencilTest?: boolean) {
        ...
        if (this.compositeMaterial.uniforms.tScene) this.compositeMaterial.uniforms.tScene.value = readBuffer.texture;
        if (this.compositeMaterial.uniforms.tFog) this.compositeMaterial.uniforms.tFog.value = this.halfResTarget.texture;
