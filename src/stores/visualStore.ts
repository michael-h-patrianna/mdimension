...
export const DEFAULT_BLOOM_INTENSITY = 1.60;
export const DEFAULT_BLOOM_THRESHOLD = 0;
export const DEFAULT_BLOOM_RADIUS = 0.65;
...
export const DEFAULT_SPECULAR_INTENSITY = 1.0;
export const DEFAULT_SPECULAR_POWER = 32;
    ...
    set((state) => ({
      shaderSettings: {
        ...
        surface: {
          ...
          specularPower: settings.specularPower !== undefined
