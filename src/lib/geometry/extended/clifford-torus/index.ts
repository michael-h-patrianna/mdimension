 ...
 *
 * @deprecated Use getAvailableTypes() to check object type availability instead.
 ...
 */
export function isVisualizationModeAvailable(mode: 'flat' | 'nested', dimension: number): boolean {
  switch (mode) {
    case 'flat':
