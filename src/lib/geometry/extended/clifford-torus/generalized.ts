 ...
 */
export function buildGeneralizedCliffordTorusFaces(k: number, stepsPerCircle: number): number[][] {
...
export function generateGeneralizedCliffordTorus(
  ...
  const edges: [number, number][] =
    edgeMode === 'grid' ? buildGeneralizedCliffordTorusEdges(k, stepsPerCircle) : []
