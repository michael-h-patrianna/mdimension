/**
 * Mandelbrot Color Palette Utilities
 *
 * Generates colors for Mandelbrot visualization based on escape time values.
...
import type { MandelbrotConfig, MandelbrotPalette } from '../types';
 ...
 *
 * This is the main entry point for coloring Mandelbrot point clouds.
 *
