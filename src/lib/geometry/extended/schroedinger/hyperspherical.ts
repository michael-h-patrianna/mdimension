/**
 * Hyperspherical Coordinate Math for N-Dimensional Schroedinger Fractals
 *
 * Implements dimension-agnostic hyperspherical coordinate transformations
 * for generating Schroedinger-style fractals in dimensions 4-11.
 *
 * The Schroedinger generalizes the 3D fractal to arbitrary dimensions using
...
/**
 * Schroedinger-style power map in D dimensions
 *
...
/**
 * Single iteration step for the Schroedinger fractal (dimensions >= 4)
 *
 ...
 */
export function schroedingerHyperbulbStep(
  z: VectorND,
  c: VectorND,
  power: number = 8,
  eps: number = 1e-12
...
/**
 * Compute escape time for a point c using the Schroedinger iteration
 *
 ...
 */
export function schroedingerHyperbulbEscapeTime(
  c: VectorND,
  power: number = 8,
  maxIter: number = 60,
  bailout: number = 8,
 ...
 */
export function schroedingerHyperbulbSmoothEscapeTime(
  c: VectorND,
  power: number = 8,
  maxIter: number = 60,
  bailout: number = 8,
