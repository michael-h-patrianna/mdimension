...
export const OBJECT_TYPE_REGISTRY: ObjectTypeRegistry = new Map<ObjectType, ObjectTypeEntry>([
  ...
  [
    'mandelbrot',
    {
      type: 'mandelbrot',
      name: 'Mandelbulb',
      description: 'Fractal via escape-time iteration (3D: Mandelbulb, 4D+: Hyperbulb)',
      category: 'fractal',
      ...
      dimensions: {
        ...
        max: 11,
        recommended: 4,
        recommendedReason: '4D Hyperbulb provides best balance of detail and performance',
      },
      ...
      animation: {
        ...
        systems: {
          ...
          juliaMorphing: {
            name: 'Julia Morphing',
            description: 'Morphs between Mandelbrot and Julia modes',
            enabledByDefault: false,
      ...
      ui: {
        controlsComponentKey: 'MandelbrotControls',
        hasTimelineControls: true,
        qualityPresets: ['draft', 'standard', 'high', 'ultra'],
      },

      configStoreKey: 'mandelbrot',
    },
  ],
