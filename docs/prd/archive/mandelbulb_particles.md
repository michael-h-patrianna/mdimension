# Mandelbulb Particle Rendering Modes

## Overview

This feature adds three distinct rendering modes for mandelbulb fractals: the existing solid surface rendering plus two new particle-based modes. Users can choose between a solid surface, a shell of particles near the surface, or GPU-instanced particles projected onto the SDF surface. Users access these settings through the Faces section > Material tab in the sidebar.

---

## User Story 1: Render Mode Selection

**User story:** As a user viewing a mandelbulb fractal, I want to select between different rendering styles so that I can visualize the fractal as a solid surface or as a particle system.

**Acceptance criteria**
1. User sees a "Render Style" dropdown in the Material tab when viewing a mandelbulb fractal
...
6. When switching from mandelbulb to a polytope object type, the Render Style dropdown is hidden
...
- Given the user is viewing a 4D mandelbulb with "Surface" mode selected
...
- Given the user has selected "Shell Particles" mode for a mandelbulb
...
**User story:** As a user, I want to render the mandelbulb as a solid raymarched surface so that I can see the precise mathematical form of the fractal.
...
- When the user views the mandelbulb
...
- When the user views a mandelbulb
...
**User story:** As a user, I want to render the mandelbulb as scattered particles forming a shell around the surface so that I can create a dust-like or debris effect visualization.
...
**User story:** As a user, I want to render the mandelbulb as particles precisely projected onto the surface so that I can visualize the fractal form with individual particles that could potentially animate or interact.
...
- Given the user is viewing an 8D mandelbulb in Instanced Projection mode
...
- Given the user is viewing a 10D mandelbulb
...
**Feature**: Mandelbulb Particle Rendering Modes
